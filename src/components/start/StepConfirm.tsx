      ...
      <div className="confirm-left">
        <div className="confirm-card">
          ...
          <div className="confirm-card-body">
            ...
            <ConfirmRow label="阶层" value={personalInfo.socialClass} />
            <ConfirmRow label="所属组织" value={personalInfo.organization} />
            <ConfirmRow label="特殊身份" value={personalInfo.specialIdentity} />
