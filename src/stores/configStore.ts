...
const translations: Record<Language, Record<string, string>> = {
  'zh-CN': {
    ...
    'nav.notebook': '笔记', 'nav.business': '商业', 'nav.variables': '变量管理', 'nav.worldbook': '世界书', 'nav.memory': '记忆系统',
  ...
  'en': {
    ...
    'nav.notebook': 'Notes', 'nav.business': 'Business', 'nav.variables': 'Variables', 'nav.worldbook': 'World Book', 'nav.memory': 'Memory',
